    ...
    def render(self):
        ...
        if self.way == "r" and self.place[0] % board_size > board_size // 4 and self.pos[0] * board_size + left_side < \
            ...
            self.pos[0] += 1
                ...
                self.place[0]:
            self.pos[0] -= 1
        elif self.way == "d" and self.place[1] % board_size > board_size // 4 and self.pos[1] * board_size < self.place[1]:
            self.pos[1] += 1
        elif self.way == "u" and self.place[1] % board_size < board_size // 4 and self.pos[1] * board_size > self.place[1]:
            self.pos[1] -= 1
        if self.alive:
            self.hot_change_way()
